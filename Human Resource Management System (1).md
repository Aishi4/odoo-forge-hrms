...
|---|---|
|Admin / HR<br>Officer|Manages employees, approves leave & attendance, views<br>payroll details|
|Employee|Views personal profile, attendance, applies for leave, views<br>salary details|
...
- Employees can edit limited fields (address, phone, profile picture). ● Admin can edit all employee details. 
...
○ Choose date range by directly selecting on calendar 

○ Add remarks, show attendance in a monthly calendar with Present/Absent markers. 
